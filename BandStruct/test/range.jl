...
show_equality_result(
  "LBC Matrix column els_range",
  compare_ranges,
  column_els_ranges_lbc0,
  [els_range(lbc0, :, k) for k = 1:10],
)
...
show_equality_result(
  ...
  compare_ranges,
  upper_column_els_ranges_lbc0,
  [upper_els_range(lbc0, :, k) for k = 1:10],
)
...
show_equality_result(
  ...
  compare_ranges,
  upper_column_els_ranges_lbc0,
  [upper_els_range(bc0, :, k) for k = 1:10],
)
...
show_equality_result(
  ...
  compare_ranges,
  middle_column_els_ranges_lbc0,
  [middle_els_range(lbc0, :, k) for k = 1:10],
)
...
show_equality_result(
  ...
  compare_ranges,
  middle_column_els_ranges_lbc0,
  [middle_els_range(bc0, :, k) for k = 1:10],
)
...
show_equality_result(
  ...
  compare_ranges,
  lower_column_els_ranges_lbc0,
  [lower_els_range(lbc0, :, k) for k = 1:10],
)
...
show_equality_result(
  ...
  compare_ranges,
  lower_column_els_ranges_lbc0,
  [lower_els_range(bc0, :, k) for k = 1:10],
)
...
show_equality_result(
  ...
  [upper_els_range(bc1, :, k) for k = 1:8],
)
...
show_equality_result(
  ...
  [middle_els_range(bc1, :, k) for k = 1:8],
)
...
show_equality_result(
  ...
  [lower_els_range(bc1, :, k) for k = 1:8],
)
...
show_equality_result(
  ...
  [upper_els_range(bc1, j, : ) for j = 1:6],
)
...
show_equality_result(
  ...
  [middle_els_range(bc1, j, : ) for j = 1:6],
)
...
show_equality_result(
  ...
  [lower_els_range(bc1, j, : ) for j = 1:6],
)
