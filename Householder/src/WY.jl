...
function InPlace.apply_right!(
  ...
  InPlace.apply_right!(wy1, wy1.active_WY[], wy2, wy2.active_WY[])
end
...
function InPlace.apply_right!(
  ...
  @inbounds @views begin
    ...
    # TODO: Avoid making this shift...
    wy2.offsets[l2] = wy2_offset - wy1_offset
    InPlace.apply_inv!(wy2, l2, wy1.Y[1:wy1_size, 1:wy1_num_hs, l1])
...
function InPlace.apply_right_inv!(
  ...
  InPlace.apply_right_inv!(wy1, wy1.active_WY[], wy2, wy2.active_WY[])
end
...
function InPlace.apply_right_inv!(
  ...
  @inbounds @views begin
    # Do a shift and unshift of wy2's offset to apply to wy1.
    wy2.offsets[l2] = wy2_offset - wy1_offset
    InPlace.apply!(wy2, l2, wy1.Y[1:wy1_size, 1:wy1_num_hs, l1])
    wy2.offsets[l2] = wy2_offset
...
function InPlace.apply_left!(
  ...
  InPlace.apply_left!(wy1, wy1.active_WY[], wy2, wy2.active_WY[])
end
...
function InPlace.apply_left!(
  ...
  @inbounds @views begin
    ...
    wy1.offsets[l1] = wy1_offset - wy2_offset
    InPlace.apply!(wy1, l1, wy2.W[1:wy2_size, 1:wy2_num_hs, l2])
    wy1.offsets[l1] = wy1_offset
...
function InPlace.apply_left_inv!(
  ...
  InPlace.apply_left_inv!(wy1, wy1.active_WY[], wy2, wy2.active_WY[])
end
...
function InPlace.apply_left_inv!(
  ...
  @inbounds @views begin
    # Do a shift and unshift of wy1's offset to apply to wy2.
    wy1.offsets[l1] = wy1_offset - wy2_offset
    InPlace.apply_inv!(wy1, l1, wy2.W[1:wy2_size, 1:wy2_num_hs, l2])
    wy1.offsets[l1] = wy1_offset
    # column indices to sort W1 and Y1 in W2 and Y2
    col_inds1 = (wy2_num_hs + 1):(wy2_num_hs + wy1_num_hs)
    wy2.num_hs[l2] = wy2_num_hs + wy1_num_hs
